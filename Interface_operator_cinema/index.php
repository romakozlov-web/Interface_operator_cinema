 ...
 * Supports both user and admin modes with password protection
 */
...
<body class="<?php echo $isAdminMode ? 'admin-mode' : 'user-mode'; ?>">
    <div class="container">
        <header class="header <?php echo $isAdminMode ? '' : 'user-header'; ?>">
            ...
            <div class="user-info">
                ...
                <?php else: ?>
                    <span class="user-mode-badge"><i class="fas fa-user"></i> Пользователь</span>
                <?php endif; ?>
        ...
        <div class="main-content">
            <aside class="sidebar <?php echo $isAdminMode ? '' : 'user-sidebar'; ?>">
                <div class="sidebar-section">
                    ...
                    <ul class="table-list">
                        ...
                        <li class="<?php echo $currentTable === 'sessions' ? 'active' : ''; ?>">
                            <a href="?table=sessions"><i class="fas fa-clock"></i> Сеансы</a>
                        </li>
                        <?php if ($isAdminMode): ?>
                ...
                <div class="sidebar-section">
                    <h3><i class="fas fa-key"></i> Доступ</h3>
                    <div class="role-switcher">
                        <?php if ($isAdminMode): ?>
                            <a href="auth.php?action=logout" class="btn btn-sm btn-block btn-logout">
                                <i class="fas fa-sign-out-alt"></i> Выход из админки
                            </a>
                        <?php else: ?>
                            <button class="btn btn-sm btn-block btn-admin-login" id="adminLoginBtn" onclick="showPasswordModal()">
                                <i class="fas fa-lock"></i> Войти как админ
                            </button>
                        <?php endif; ?>
                    </div>
                </div>
    ...
    <div id="passwordModal" class="modal-overlay">
        <div class="modal-content">
            ...
            <div class="form-group">
                <label for="adminPassword"><i class="fas fa-key"></i> Пароль (тестовый: admin123):</label>
                <input type="password" id="adminPassword" class="form-control" placeholder="Введите пароль" autofocus>
            </div>
            <div class="modal-actions">
                <button class="btn btn-sm" id="submitPassword"><i class="fas fa-sign-in-alt"></i> Войти</button>
                <button class="btn btn-sm btn-secondary" id="cancelPassword"><i class="fas fa-times"></i> Отмена</button>
            </div>
        </div>
    </div>
